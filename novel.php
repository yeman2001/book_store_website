...
// Execute the query
$result = mysqli_query($conn, "SELECT COUNT(*) as total_products FROM products WHERE type=70");
...
<body>
   <section class="big-con-pro-intro">
      <nav class="header-title">
         ...
         <a href="category_products.php?type=70">view all <span class="amount-products-">(<?php echo $total_products; ?>)</span></a>
      </nav>
      <span for="">A book that will enchant you into the world of imagination.</span>
